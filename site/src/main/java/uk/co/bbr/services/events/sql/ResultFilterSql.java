...
public class ResultFilterSql {
    ...
    private static final String CONTEST_FILTERED_TO_POSITION_SQL = """
            SELECT e.date_of_event, e.date_resolution, c.slug, r.result_position, r.result_position_type, r.band_name, b.name as actual_band_name, b.slug as band_slug, reg.name as region_name, reg.slug as region_slug, reg.country_code, r.draw, r.points_total,
                           ...
                           AND r.result_position = ?2
                           ORDER BY e.date_of_event DESC""";

    public static List<ContestResultDrawPositionSqlDto> selectContestResultsForPosition(EntityManager entityManager, String contestSlug, String position) {
        return SqlExec.execute(entityManager, CONTEST_FILTERED_TO_POSITION_SQL, contestSlug, position, ContestResultDrawPositionSqlDto.class);
    }

    private static final String CONTEST_FILTERED_TO_DISQUALIFIED_SQL = """
            SELECT e.date_of_event, e.date_resolution, c.slug, r.result_position, r.result_position_type, r.band_name, b.name as actual_band_name, b.slug as band_slug, reg.name as region_name, reg.slug as region_slug, reg.country_code, r.draw, r.points_total,
                                  con1.slug as c1_slug, con1.first_names as c1_first_names, con1.surname as c1_surname,
                                  con2.slug as c2_slug, con2.first_names as c2_first_names, con2.surname as c2_surname,
                                  con3.slug as c3_slug, con3.first_names as c3_first_names, con3.surname as c3_surname
                           ...
                           LEFT OUTER JOIN person con3 ON con3.id = r.conductor_three_id
                           WHERE c.slug = ?1
                           AND r.result_position_type = 'D'
                           ORDER BY e.date_of_event DESC""";

    public static List<ContestResultDrawPositionSqlDto> selectContestResultsForDisqualified(EntityManager entityManager, String contestSlug) {
        return SqlExec.execute(entityManager, CONTEST_FILTERED_TO_DISQUALIFIED_SQL, contestSlug, ContestResultDrawPositionSqlDto.class);
    }

    private static final String CONTEST_FILTERED_TO_WITHDRAWN_SQL = """
            SELECT e.date_of_event, e.date_resolution, c.slug, r.result_position, r.result_position_type, r.band_name, b.name as actual_band_name, b.slug as band_slug, reg.name as region_name, reg.slug as region_slug, reg.country_code, r.draw, r.points_total,
                                  con1.slug as c1_slug, con1.first_names as c1_first_names, con1.surname as c1_surname,
                                  con2.slug as c2_slug, con2.first_names as c2_first_names, con2.surname as c2_surname,
                                  con3.slug as c3_slug, con3.first_names as c3_first_names, con3.surname as c3_surname
    ...
    public static List<ContestResultDrawPositionSqlDto> selectContestResultsForWithdrawn(EntityManager entityManager, String contestSlug) {
        return SqlExec.execute(entityManager, CONTEST_FILTERED_TO_WITHDRAWN_SQL, contestSlug, ContestResultDrawPositionSqlDto.class);
    }
