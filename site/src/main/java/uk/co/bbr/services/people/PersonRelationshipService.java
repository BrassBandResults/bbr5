...
public interface PersonRelationshipService {
    ...
    PersonRelationshipDao updateRelationship(PersonRelationshipDao relationship);
    PersonRelationshipDao migrateRelationship(PersonRelationshipDao relationship);
