...
public class LookupSql {
    ...
    public static List<LookupSqlDto> lookupVenueAlias(EntityManager entityManager, String searchString) {
        return SqlExec.execute(entityManager, VENUE_ALIAS_LOOKUP_SQL, "%" + searchString.toUpperCase() + "%", LookupSqlDto.class);
    }

    public static List<LookupSqlDto> lookupPieceAlias(EntityManager entityManager, String searchString) {
        return SqlExec.execute(entityManager, PIECE_ALIAS_LOOKUP_SQL, "%" + searchString.toUpperCase() + "%", LookupSqlDto.class);
    }

    public static List<LookupSqlDto> lookupPeopleAlias(EntityManager entityManager, String searchString) {
        return SqlExec.execute(entityManager, PEOPLE_ALIAS_LOOKUP_SQL, "%" + searchString.toUpperCase() + "%", LookupSqlDto.class);
    }

    public static List<LookupSqlDto> lookupContestAlias(EntityManager entityManager, String searchString) {
        return SqlExec.execute(entityManager, CONTEST_ALIAS_LOOKUP_SQL, "%" + searchString.toUpperCase() + "%", LookupSqlDto.class);
    }

    public static List<LookupSqlDto> lookupBandAlias(EntityManager entityManager, String searchString) {
        return SqlExec.execute(entityManager, BAND_ALIAS_LOOKUP_SQL, "%" + searchString.toUpperCase() + "%", LookupSqlDto.class);
    }
}
