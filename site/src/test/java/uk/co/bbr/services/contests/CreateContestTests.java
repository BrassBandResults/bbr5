...
@ActiveProfiles("test")
@SpringBootTest(properties = { "spring.config.name=create-contest-tests-h2", "spring.datasource.url=jdbc:h2:mem:create-contest-tests-h2;DB_CLOSE_DELAY=-1;MODE=MSSQLServer;DATABASE_TO_LOWER=TRUE"})
