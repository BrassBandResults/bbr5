...
@ActiveProfiles("test")
@SpringBootTest(properties = { "spring.config.name=venue-list-page-service-tests-h2", "spring.datasource.url=jdbc:h2:mem:venue-list-page-service-tests-h2;DB_CLOSE_DELAY=-1;MODE=MSSQLServer;DATABASE_TO_LOWER=TRUE"})
