...
@ActiveProfiles("test")
@SpringBootTest(properties = { "spring.config.name=contest-list-page-service-alias-tests-h2", "spring.datasource.url=jdbc:h2:mem:contest-list-page-service-alias-tests-h2;DB_CLOSE_DELAY=-1;MODE=MSSQLServer;DATABASE_TO_LOWER=TRUE"})
