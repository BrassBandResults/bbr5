...
@SpringBootTest(properties = {  "spring.config.location=classpath:test-application.yml",
        "spring.datasource.url=jdbc:h2:mem:results-add-results-test-piece-tests-admin-h2;DB_CLOSE_DELAY=-1;MODE=MSSQLServer;DATABASE_TO_LOWER=TRUE"},
        webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
class AddResults4TestPieceWebTests implements LoginMixin {
    ...
    void setupData() throws AuthenticationFailedException {
        ...
        this.contestEventService.create(yorkshireArea, LocalDate.of(2000, 3, 17));
        this.contestEventService.create(yorkshireArea, LocalDate.of(2000, 3, 18));
    ...
    void testUpdatePieceWorksSuccessfully() {
        ...
        map.add("testPieceName", "Contest Music");
        map.add("testPieceSlug", "contest-music");
        ...
        // act
        ResponseEntity<String> response = this.restTemplate.postForEntity("http://localhost:" + port + "/add-results/4/yorkshire-area/2000-03-15", request, String.class);
    ...
    @Test
    void testBlankPieceWorksSuccessfully() {
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.MULTIPART_FORM_DATA);
        ...
        // act
        ResponseEntity<String> response = this.restTemplate.postForEntity("http://localhost:" + port + "/add-results/4/yorkshire-area/2000-03-17", request, String.class);
    ...
    @Test
    void testEmptyPieceWorksSuccessfully() {
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.MULTIPART_FORM_DATA);
        ...
        // act
        ResponseEntity<String> response = this.restTemplate.postForEntity("http://localhost:" + port + "/add-results/4/yorkshire-area/2000-03-18", request, String.class);
